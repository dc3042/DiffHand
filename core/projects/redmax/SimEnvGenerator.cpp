...
Simulation* SimEnvGenerator::createDavidCustomDemo(std::string integrator) {
    ...
    // MCP
    Joint* joint0 = new JointRevolute(sim, 0, Vector3(0, 0, -1), nullptr, Matrix3::Identity(), Vector3(0., 7, 0.));
    joint0->set_damping(1e4);
    BodyCuboid* body0 = new BodyCuboid(sim, joint0, Vector3(4, 1, 1), Matrix3::Identity(), Vector3(2., 0., 0.), 1.);
    Actuator* actuator0 = new ActuatorMotor(joint0, -1e5, 1e5);
    robot->add_actuator(actuator0);
    ...
    // Box
    Joint* box_joint = new JointFree2D(sim, 0, nullptr, Matrix3::Identity(), Vector3(4, 0.5, 0.0));
    BodyCuboid* box = new BodyCuboid(sim, box_joint, Vector3(1, 1, 1), Matrix3::Identity(), Vector3::Zero(), 1.);
    box->set_color(Vector3(0., 0.2, 0.4));
    ...
    // add spring force
    ForceSpring* forceS1 = new ForceSpring(sim, body0, body1, 6, 2, 1000, 0);
    ForceSpring* forceS2 = new ForceSpring(sim, body0, body1, 7, 3, 1000, 0);
    ForceSpring* forceS3 = new ForceSpring(sim, body0, body1, 4, 4, 1000, 2);
    ForceSpring* forceS4 = new ForceSpring(sim, body0, body1, 5, 5, 1000, 2);
    robot->add_force(forceS1);
    robot->add_force(forceS2);
    //robot->add_force(forceS3);
    //robot->add_force(forceS4);

    ForceSpring* forceS5 = new ForceSpring(sim, body1, body2, 6, 2, 1000, 0);
    ForceSpring* forceS6 = new ForceSpring(sim, body1, body2, 7, 3, 1000, 0);
    ForceSpring* forceS7 = new ForceSpring(sim, body1, body2, 4, 4, 1000, 1);
    ForceSpring* forceS8 = new ForceSpring(sim, body1, body2, 5, 5, 1000, 1);
    robot->add_force(forceS5);
    robot->add_force(forceS6);
    //robot->add_force(forceS7);
    //robot->add_force(forceS8);
